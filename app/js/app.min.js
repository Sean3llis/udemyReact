...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewStackForm = __webpack_require__(217);
	var StackList = __webpack_require__(213);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createHashHistory = __webpack_require__(163);
	...
	module.exports = React.createElement(
		...
		React.createElement(
			Route,
			{ path: '/', component: Main },
			React.createElement(Route, { path: 'stacks', component: StackList }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SideNav = __webpack_require__(211);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SideLink = __webpack_require__(212);
	...
	var sideNav = React.createClass({
		...
		getInitialState: function () {
			return {
				links: [{ target: 'stacks', icon: 'database' }, { target: 'hello', icon: 'crop' }]
			};
		},
		createSideLink: function (link, i) {
			return React.createElement(SideLink, { key: i, target: link.target, icon: link.icon });
		},
		render: function () {
			return React.createElement(
				'div',
	...
	var sideNavLink = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					Link,
					{ activeClassName: 'active', to: this.props.target },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ColorStack = __webpack_require__(214);
	var ReactFire = __webpack_require__(215);
	...
	var stackList = React.createClass({
		...
		createStacks: function (stack, i) {
			return React.createElement(ColorStack, {
				colors: stack.values,
				key: i,
				title: stack.title
			});
	...
	var ColorStack = React.createClass({
		...
		render: function () {
			var list = this.props.colors.map(function (hex, i) {
				...
				return React.createElement(
					"div",
					{ key: i, className: "colorChip", style: style },
					hex
				);
			});
			var stackStyle = {
			...
			return React.createElement(
				"div",
				{ className: "colorStack", style: stackStyle },
				list,
				React.createElement(
					"div",
	...
	var NewStackForm = React.createClass({
		...
		handleSubmit: function () {
			this.props.stacksStore.push({
				stack: ["#2A363B", "#E84A5F", "#FF847C", "#FECEA8", "#99B898"]
			});
			this.setState({ text: '' });
		},
		render: function () {
			return React.createElement(
				'div',
				{ className: 'newColorStack form-group' },
				React.createElement(
					'label',
					null,
					'test'
